...
void main()
{ unsigned int a,b,c,d,e,f,g,h,adc;
int i = 0;
int flag =0;
...
PORTD=seg[g];RC0=1;
_delay((unsigned long)((5)*(20000000/4000.0)));RC0=0;
PORTD=seg[e];RD7=1;RC1=1;
_delay((unsigned long)((5)*(20000000/4000.0)));RC1=0;
PORTD=seg[c];RC2=1;
_delay((unsigned long)((5)*(20000000/4000.0)));RC2=0;
PORTD=seg[a];RC3=1;
_delay((unsigned long)((5)*(20000000/4000.0)));RC3=0;
