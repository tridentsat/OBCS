...
# 2 "supporting c files/lcd.c" 2
# 11 "supporting c files/lcd.c"
short int status=0;
# 22 "supporting c files/lcd.c"
void delay(unsigned int j)
{
 unsigned int i=0;
 for(i=0;i<j;i++);
