...
{
short int flag =0;
double x,y,z,negx,negy,r;
double A[5];
short int i;
unsigned int a,b,c,d,e,f,g,h;
unsigned int seg[]={0XC0,
                    0XF9,
                    0XA4,
                    0XB0,
                    0X99,
...
r= sqrt((x+negx)*(x+negx) + (y+negy)*(y+negy) + z*z)+1;
 A[0] = acos((x/r))*57.29 ;
 A[1] = acos((y/r))*57.29 ;
 A[2] = acos((z/r))*57.29 ;
...
PORTD=seg[g];RC0=1;
_delay((unsigned long)((500)*(20000000/4000.0)));RC0=0;
PORTD=seg[e];RD7=1;RC1=1;
_delay((unsigned long)((500)*(20000000/4000.0)));RC1=0;
PORTD=seg[c];RC2=1;
_delay((unsigned long)((500)*(20000000/4000.0)));RC2=0;
PORTD=seg[a];RC3=1;
_delay((unsigned long)((500)*(20000000/4000.0)));RC3=0;
