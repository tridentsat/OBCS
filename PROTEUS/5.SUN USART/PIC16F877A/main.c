...
UART_send_string(" X AXIS: "); 
    UART_send_float(A);	UART_send_char(13);	UART_send_float(x);	UART_send_char(13);
UART_send_string(" Y AXIS: "); 
    UART_send_float(B);	UART_send_char(13);	UART_send_float(y);	UART_send_char(13);
UART_send_string(" Z AXIS: "); 
    UART_send_float(C);	UART_send_char(13);	UART_send_float(negx);	UART_send_char(13);
UART_send_string(" NEG X AXIS: "); 
    UART_send_float(D);	UART_send_char(13);	UART_send_float(negy);	UART_send_char(13);
UART_send_string(" NEG Y AXIS:"); 
    UART_send_float(E);	UART_send_char(13);	UART_send_float(z);	UART_send_char(13);
	__delay_ms(1000);
UART_send_char(13);	UART_send_char(13);
 //} //if end
}//ehile end
}//main end
